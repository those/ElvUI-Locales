...
L["Display the target of the cast on the castbar."] = "Afficher le sort en cours d'incantation de la cible sur votre barre d'incantation." --Need review
...
L['Force the frames to show, they will act as if they are the player frame.'] = "Forcer l'affichage des cadres, ils se comporteront comme si c'est le cadre du joueur." --Need review
L["Format"] = "Format"
L["Frame"] = "Fenêtre"
