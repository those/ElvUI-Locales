...
--ActionBars => Partly translated, in progress (3)
...
--Bags => Partly translated, in progress (14)
...
L['Your Auras First'] = true;
 ...
 --Chat => Partly translated, in progress (11)
...
--Config / Install => Partly translated, in progress (10)
...
--General => Partly translated, in progress (x)
...
L["Raid40 Frames"] = "Cadre de Raid40"
L["Raid25 Frames"] = "Cadre de Raid25"
