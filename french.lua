...
L['Location Text'] = "Texte d'emplacement"
L["lvl"] = "niv"
L["Main Hand"] = "Main droite"
L["middle"] = "Milieu"
L['Minimap Mouseover'] = "Minicarte au survol"
...
L['Display emotion icons in chat.'] = "Afficher les émoticônes dans le Chat" --Need review for emotion icons
...
L["Embedded Bar Height"] = "Hauteur de la barre intégré"
...
L["Stable"] = "Stable" --Need Review
L["Tabard Frame"] = "Tabard"
L["Talent Frame"] = "Feuille des talents"
L["Taxi Frame"] = "Trajets aériens"
L["The height of the bars while skada is embedded."] = "Hauteur des barres quand Skada est intégré"
...
L['Force the frames to show, they will act as if they are the player frame.'] = "Forcer l'affichage des cadres, ils se comporteront comme si est le cadre du joueur." --Need review
L["Format"] = "Format"
L["Frame"] = "Fenêtre"
...
L['No Duration'] = "Aucune durée"  --or Sans durée
L["None"] = "Aucun"
...
L['Size Override'] = "Taille de substitution" --Need review
L["Size"] = "Taille"
