...
L["LOCK_AB_ERROR"] = "Es ist aufgefallen das deine Aktionsleisten nicht gesperrt sind. Das kann dazu führen das du Fähigkeiten auslöst wenn du deine Tasten verschieben willst. Bitte benutze den CVars Teil im Installationsprozess (Schritt 2). Das kann durch eingeben von /ec und klicken auf ide Installationtaste erledigt werden."
...
L["Enable Bag-Bar"] = "Aktiviere Taschen-Leiste"
...
L["LOGIN_MSG"] = "Willkommen zu %sElvUI|r Version %s%s|r, Tippe /ec um das Ingame Konfigurations Menüaufzurufen. Für technischen Support, besuche das Supportforum unter http://www.tukui.org. Du kannst Bugs reporten, und vorschläge einbringen: http://www.tukui.org/tickets/elvui/."
...
L['If your experience and reputation bars disappear, mouse over the place where they were and click them again.'] = 'Wenn deine Erfahrungs und Ruf Leiste verschwunden ist, bewege deine Maus über den Platz an dem sich diese befinden und klicke diese an um sie wieder anzuzeigen.'
...
L['Color the name text by class or reaction.'] = 'Färbe den Namenstext nach Klasse oder Reaktion.'
...
L["xOffset"] = "xVersatz"
L["yOffset"] = "yVersatz" --Another variation in bags section Y Offset
