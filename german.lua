...
L["LOGIN_MSG"] = "Willkommen zu %sElvUI|r Version %s%s|r, Tippe /ec um das Ingame Konfigurations Menüaufzurufen. Für technischen Support, besuche das Supportforum unter http://www.tukui.org"
...
L['You can toggle the microbar by using your middle mouse button on the minimap you can also accomplish this by enabling the actual microbar located in the actionbar settings.'] = 'Du kannst die Mikroleiste durch mittleren Mausklick auf der Minimap aufrufen oder auch die tatsächlcihe Mikroleiste in den Aktionsleisten Optionen aktivieren.' 
